...
bool XFiles = false;      // XKeys active replacing Cut Copy Paste in Layouts M S T - static const bool XFiles = true;
...
bool SaveLayout = false;               // Start with selected layout 1 or 2
...
{ uint8_t keycode[6] = { 0 };  
  ...
  keycode[2] = 0x00; 
  Serial.println(); Serial.print("XNum "); Serial.print(xNum); 
  Serial.print(" kc0 "); Serial.print(keycode[0]); Serial.print(" kc1 "); Serial.println(keycode[1]);
  usb_hid.keyboardReport(HIDKbrd, 0, keycode); delay(keydelay2); 
  usb_hid.keyboardRelease(HIDKbrd);            delay(keydelay2);
  return true;
}
...
void ConfigButtons(uint8_t rowcount) {  // rowcount=0 all 4 rows rowcount=2 last row only  rowcount=1 no background redraw 
  ...
  //   "Hme", "Up",   "PgU", "Del/V+",  "<",    "Cfg", ">",    "V0/L14",  "End", "Dwn", "PgD", "V-/Ret"
  //   "1L4", "Var",  "Vol", "   ",     "A-D",  "Sav", "Med",  "   ",     "Del", "Kbd",  "1S2", "   " 
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
