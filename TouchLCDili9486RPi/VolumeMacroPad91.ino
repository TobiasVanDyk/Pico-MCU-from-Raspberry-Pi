...
// Adapted by T van Dyk Aug - Dec 2022 for ILI9486/ILI9488 480x320 and Adafruit TinyUSB stack
////////////////////////////////////////////////////////////////////////////////////////////// 
/************************************************************************************
  ...
  switch(button){
    ...
    case 5: // CONFIG //////////////////////////////////////////////////
      ...
      if (ConfigKeyCount==1) { status("Config and Files Saved"); ConfigKeyCount = 0; }
                        else { status("1L4 Bs Vol AD Sav Med Del Po 1S2"); ConfigKeyCount++ ; } 
      ConfigButtons(1);  break;
...
{ char *ChrPtr;
  ...
  Serial.println("Version: VolumeMacro84 GPL3 Tobias van Dyk Dec 2022");
