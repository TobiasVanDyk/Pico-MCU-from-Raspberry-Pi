...
char padLabel[5][4] = {"", "", "", "", ""}; 
uint16_t padColor[20]   = {DGrey, Black, Black, Black, DGrey, Red,   Blue,  Green4, SkyBlue, Gold,  
                           DGrey, Black, Black, Black, DGrey, DGrey, Black, Black,  Black,   DGrey };
uint16_t padOutline[20] = {White, Black, Black, Black, White, White, White, White,  White,   White, 
                           White, Black, Black, Black, White, White, Black, Black,  Black,   White};
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////
{
  ...
  if ((button==12 || button==16) && Layout!=2) { LayerAB = (LayerAB==0); PadKeys = true; LayerABStr[6] = 65 + LayerAB; status(LayerABStr); ConfigButtons(1); return; }
