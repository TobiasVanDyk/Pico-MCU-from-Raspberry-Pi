...
{"abc",  "def",  "ghi",  "EXE", "jkl", "mno", "pqr", "NXT", "stu", "vwx", "yz ", "ADD",    // ASCII->HID Subtract  dec
 ...
 "Lst",  "Ren",  "Rmv",  "EXE", "Snd", "Cpy", "Lnk", "NXT", "Src", "Dst", "Num", "ADD",    // *Cm=StarCodes Lst=MacroContent Rmv=RemoveMacro
...
{ String NameStr;
  ...
  byte *BPtr;
  int m, n;  
  for (n=0; n<36; n++) Int2HexStr[n] = 0x20; // fill with spaces not NULL
...
{   int i, n;
    ...
    if (KeyBrdX==3) {if (button==0)   { ListMacro();                                  return; } 
                     ...
                     if (button==4)   { if (SendMacro()) status("Macro Sent");        return; } 
