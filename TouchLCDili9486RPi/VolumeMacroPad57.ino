...
// See: Location\2.6.3\pico-sdk\src\rp2040\hardware_structs\include\hardware\structs\rtc.h
//      Location\2.6.3\pico-sdk\src\rp2040\hardware_regs\include\hardware\regs\rtc.h
//      Location\2.6.3\pico-sdk\src\rp2_common\hardware_rtc\include\hardware\rtc.h

...
char padLabel[20][2] = {"A", "M", "S", "T", "B", "1", "2", "3", "4", "5", "A", "M", "S", "T", "B", "A", "M", "S", "T", "B"}; 

uint16_t padColor[20]   = {Violet, LGrey, SkyBlue, Pink, Violet, Red,    Blue,  Green4,  SkyBlue, Orange,  
...
{ char KeyBrd5status[16] =   {"Macro nn -> Xnn"};
  ...
  if (KeyBrdByteNum>4) { MST = KeyBrdByte[6]-77; if (MST>0) MST = MST-5; if (MST>2) return;   // *cm*nnXmm MSTA = 0 1 2 3 - 4 notdef
                         ...
                         MST1 = 3; MST2 = MST;                                                // Copy from a01-a99 to M S T 01-12 
                         status((char *)KeyBrd5status); Serial.println(KeyBrd5status);  }
