...
(z) Skip first key pressed in LCD in dimmed state - used to wake LCD - toggle on/off with *ks*
-----------------------------------------------------------------------------------------------------------------------
