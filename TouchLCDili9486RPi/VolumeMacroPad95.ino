...
// Adapted by T van Dyk Aug 2022 - Apr 2023 for ILI9486/ILI9488 480x320 and Adafruit TinyUSB stack
////////////////////////////////////////////////////////////////////////////////////////////////// 
/************************************************************************************
...
{ // From Raspberry Pi Pico examples - seems to do nothing - assignments above still valid
  ...
  //MediaCfg = MediaConfig[0] = 0;              // Special Mediakeys modes 1-4 is off
  optionsindicators(0);
}
  ...
  switch(button){
    ...
    case 8: // END //////////////////////////////////////////////////////////////////////////////
      ...
      if (ConfigKeyCount==1) {ConfigKeyCount--;               
                              Media = !Media; 
                              Serial.println();
                              Serial.print(MediaConfig[0]); Serial.print(" "); Serial.print(MediaCfg);
                              Serial.println();
...
(w) Media Key Options: Normally pressing the media key [Cfg] then [Med], only display the four Media controls 
