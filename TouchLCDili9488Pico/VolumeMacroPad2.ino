...
///////////////////////////////////////////////////////////////////////////////////////////
//Adapted by T van Dyk Sep 2022 for ILI9488 480x320 and Adafruit TinyUSB stack
///////////////////////////////////////////////////////////////////////////////////////////
/*********************************************************************
...
///////////////////////////////////////////////////////////////////////////////
uint16_t calData[5] = {382, 3453, 410, 3235, 5};    // **[1]**
...
// Was 95 x 4 = 380 + 20 x 5 = 100 + 380 = 480
// Was 95 x 3 = 285 + 10 x 4 = 40 + 285 = 325 
// Keypad start position, key sizes and spacing
#define KEY_W 95 // Key width
#define KEY_H 80 // Key height
#define KEY_SPACING_X 20 // X gap
#define KEY_SPACING_Y 12 // Y gap

#define KEY_X 50 // X-axis centre of the first key
#define KEY_Y 50 // Y-axis centre of the first key
...
// Modified by Caps-Scroll-Num Lock Keys cannot use const 16x12 = 192
// 16 groups of 4 columns by 3 rows i.e. Layout 1 - 4 has 4 Groups 0 - 3
////////////////////////////////////////////////////////////////////////////////
uint16_t Colours[16][12] = {Blue,    Red,     Orange,  DCyan,    // Row 1 Normal L1 ///////////////////// 12 Keys group 0 12x4=48
...
{"Cut", "Cpy", "Pst", "V+",  "M1",  "M2", "M3",  "Vo",  "M4",  "M5",  "M6",  "V-",  // L1 Mute ON Vol=ON   0     Group 0 Layer A
 ...
 "Cut", "Cpy", "Pst", "V+",  "M1",  "M8", "M9",  "L1",  "M10", "M11", "M12", "V-",  // L1 Mute OFF Vol=ON         Group 1 Layer B
...
{"L14", "   ",  "D-R", "   ", "A-B",  "Sav", "   ",  "   ",  "Del", "   ", "L12", "   "};  // All 3 chars + \0
...
void setup() {
  ...
  */
  ...
  tft.setFreeFont(&FreeSansBold12pt7b);   // use KEY_TEXTSIZE 1 
  ...
  switch(button){
    ...
    case 5: // CONFIG //////////////////////////////////////////////////
      ...
      if (ConfigKeyCount==1) {status("Config and Files Saved");          ConfigKeyCount = 0; }
                        else {status("L1-L4 DeleteReturn LayoutAB Save Delete StartL1L2"); ConfigKeyCount++ ; } 
      ConfigButtons(1);
      break;
    case 6: // ARROW RIGHT /////////////////////////////////////////////
      keycode[0] = ArrRight;
...
//   "Hme", "Up",   "PgU", "Del/V+",  "<",    "Cfg", ">",    "V0/L14",  "End", "Dwn", "PgD", "V-/Ret"
//   "L14", "   ",  "D-R", "   ",     "A-B",  "Sav", " > ",  "   ",     "Del", "   ",  "L12", "   " 
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  if (ConfigKeyCount>0) 
     {for (m=0; m<3; m++) {keyLabel[0][m] = CfgLabel[0][m]; keyLabel[2][m] = CfgLabel[2][m]; keyLabel[4][m] =  CfgLabel[4][m]; 
                           keyLabel[5][m] = CfgLabel[5][m]; keyLabel[8][m] = CfgLabel[8][m]; keyLabel[10][m] = CfgLabel[10][m]; };
      keyColor[0] = keyColor[2] = keyColor[4] = keyColor[5] = CfgColour; 
...
void status(const char *msg) {
  ...
  tft.setFreeFont(&FreeSansBold12pt7b);         // KEY_TEXTSIZE 1 
  //tft.setTextSize(KEY_TEXTSIZE);
}  
