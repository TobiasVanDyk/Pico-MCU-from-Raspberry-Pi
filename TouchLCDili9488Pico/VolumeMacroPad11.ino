...
uint16_t padColor[20]   = {Blue, Black1, SkyBlue2, SkyBlue2, Blue, SkyBlue2, Black1, SkyBlue2,   Black1,    Red,  
  ...
  switch(button){
    ...
    case 5: // CONFIG //////////////////////////////////////////////////
      ...
      if (ConfigKeyCount==1) { status("Config and Files Saved"); ConfigKeyCount = 0; }                 
                        else { status("1L4 Bs Vol AD Sav Mou Del Po 1S2"); ConfigKeyCount++ ; } 
      ConfigButtons(1);  break;
