...
A repeat rnn and Rnn with r = repeat 1-99 and R - repeat 100 to 9999 similar to the existing delay dnn and Dnn with d seconds 1-99 and D minutes 1-99, is planned for the next release, which will make the macrolink string used for the animation above less awkward: **a50a51a53d05r20a52**
