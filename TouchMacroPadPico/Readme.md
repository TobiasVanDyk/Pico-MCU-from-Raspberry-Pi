...
A repeat rnn and Rnn with r = repeat 1-99 and R - repeat 100 to 9900, and a delay dnn and Dnn with d 1-99 seconds and D 1-99 minutes, was used in the macrolink string **a50a51a53d05r20a52** for the animation as shown in the right-hand picture above. Refer to the Extras - DuckyPad section for further details.

Five keys - normally the [Cut][Copy]Paste[Delete][Return[ keys - can be assigned from 33 functions in Layouts 1, 3 and 4 - the functions are: 1 Delete 2 Backspace 3 Tab  4 AltTab 5 Insert 6 Esc 7 PScr 8 AltPScr 9 Return 10 Snipping 11 OnScrKeyBrd 12 NumLock 13 CapsLock 14 ScrollLock 15 Cut 16 Copy 17 Paste 18 TaskMan 19 Run 20 GuiX 21 Copilot 22-24 Tskbar1-6 and K1-K6. The latter use the new plaintext linking method - again refer to the Extras - DuckyPad section for an example.
