...
Note 4: Macros" are considered here to be that sub-group of HID touch-keys, touch-buttons, and touch-scrollers, that when touch-pressed send and receive, simultaneous and/or sequential, in (almost) any combination and length, and with variable speed, HID data and control characters via a USB interface to a PC. 
