...
"C:\\Users\\Tobias\\AppData\\Local\\Arduino15\\packages\\rp2040\\tools\\pqt-gcc\\4.1.0-1aec55e/bin/arm-none-eabi-size" -A "I:\\Data\\Win10\\Arduino/VolumeMacroPad312.ino.elf"
Sketch uses 236316 bytes (11%) of program storage space. Maximum is 2088960 bytes.
Global variables use 46680 bytes (8%) of dynamic memory, leaving 477608 bytes for local variables. Maximum is 524288 bytes.
C:\Users\Tobias\AppData\Local\Arduino15\packages\rp2040\tools\pqt-python3\1.0.1-base-3a57aed-1/python3 -I C:\Users\Tobias\AppData\Local\Arduino15\packages\rp2040\hardware\rp2040\5.4.2/tools/uf2conv.py --serial COM3 --family RP2040 --deploy I:\Data\Win10\Arduino/VolumeMacroPad312.ino.uf2 
Resetting COM3
Converting to uf2, output size: 538624, start address: 0x2000
Scanning for RP2040 devices
Flashing D: (RP2350)
Wrote 538624 bytes to D:/NEW.UF2
----------------------------------------------------------------------------------------------------------------
...
New changes:
1. Added Backspace Delete key, green Pad [<], to MacroEditor to correct [ADD]ed entries. 4 green Pads dedicated to Macroeditor [k][<][d][o].
2. Completed all Numkey (option instead of nKeys) key values.
3. Fix PadKey status message for MouseKeys, SymbolsPages, MacroEditor, and fix Src Dst left in display if MacroMbrd not cancelled
4. Fix Black Text label on Black Key unreadable
5. Can now use up to 1080 Special Symbols (Math and Greek etc). 
...
6. Fixed Media Controls precedence and new options for media *e0* to *e6*
