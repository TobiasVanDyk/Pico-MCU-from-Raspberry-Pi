...
"C:\\Users\\Tobias\\AppData\\Local\\Arduino15\\packages\\rp2040\\tools\\pqt-gcc\\4.0.1-8ec9d6f/bin/arm-none-eabi-size" -A "I:\\Data\\Win10\\Arduino/VolumeMacroPad301.ino.elf"
Sketch uses 235156 bytes (11%) of program storage space. Maximum is 2088960 bytes.
Global variables use 41228 bytes (7%) of dynamic memory, leaving 483060 bytes for local variables. Maximum is 524288 bytes.
C:\Users\Tobias\AppData\Local\Arduino15\packages\rp2040\tools\pqt-python3\1.0.1-base-3a57aed-1/python3 -I C:\Users\Tobias\AppData\Local\Arduino15\packages\rp2040\hardware\rp2040\4.5.2/tools/uf2conv.py --serial COM14 --family RP2040 --deploy I:\Data\Win10\Arduino/VolumeMacroPad301.ino.uf2 
Resetting COM14
Converting to uf2, output size: 525312, start address: 0x2000
Scanning for RP2040 devices
Flashing D: (RP2350)
Wrote 525312 bytes to D:/NEW.UF2
----------------------------------------------------------------------------------------------------------------
...
NB: Use 4MB Flash option with 2MB Sketch 2MB FS 
    ...
    Use 150 MHz CPU:  #define SPI_TOUCH_FREQUENCY  1000000 to 250000
                      #define SPI_READ_FREQUENCY   15000000
                      #define SPI_FREQUENCY        35000000 

New changes:
1. Fixed Serial data handling
2. Added LED indicators for Time Clock set and Alarm set
3. Pico 2 version: Replaced RP2040 RTC with TimeLib for Pico 2 (RP2350) - not completely tested as yet
