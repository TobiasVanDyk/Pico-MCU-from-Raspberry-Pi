...
Sketch uses 240596 bytes (23%) of program storage space. Maximum is 1044480 bytes.
...
New changes:
1. Extended nKeys to four digits which means there are 833 pages, each 12 keys or 9,996 nKeys for each of the 36 first 
