...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
const int nKeySize = 200;            // Indirection i.e. n01-n9996 keys only holds [/folder][/]filename[.ext] of target file
...
{ char *ChrPtr;
  ...
  // SerPr2; Serial.print(nDir); SerPr1; Serial.print(c); SerPr2;
  strcpy(NameStr3, nDir); if (nDir[2]=='/') NameStr3[1] = nChar;  // Default is "/" and "//" use /nChar as folder name such as /n/nKeysfiles 
  strcat(NameStr3, NKeysX[Button]);                               // nDir = /dirname/ except if default just one / - maximum size 200 char
  // SerPr2; Serial.print(NameStr3); SerPr1; Serial.print(nDir); SerPr1; Serial.print(c); SerPr2;
  ...
  if (nKeysShow) { status(nFile); Option1 = Option2 = c; MST1 = MST2 = 5; return; }  // Only display its nKeys content
...
{ int n;
  ...
  nKeysPage = Config1[9]; if (nKeysPage<1) nKeysPage = 100;  // Old Config1 with nKeysPage=0 not valid 
...
{ char *ChrPtr;
  ...
  Serial.println("Version: VolumeMacro272 Tobias van Dyk March 2025 License GPL3");
  ...
  Serial.print("nKeys Pages Maximum: ");  Serial.print(nKeysPage);  Serial.print(" Number: "); Serial.print(12*nKeysPage); SerPr2; 
  ...
  switch(c)
      ...
      {  for (n=1;n<12;n++) RecBytes[n] = KeyBrdByte[n+3];
       ...
       { if (k2==0x78) { iList = !iList; Config1[23] = iList; WriteConfig1Change = true;      // or use WriteConfig1(0);
         ...
         case 45: ////////////////////// KeyBrdByte[1]==0x30&&KeyBrdByte[2]==0x39 *09* Number-Pad or 9996 n-Keys n01-n9996
       { nKeys = !nKeys; Config1[7] = nKeys; WriteConfig1(0); 
         if (nKeys) status("nKeys n01-n9996 (Pages 1-983)"); else status ("NumPad Pages 1-8"); NumKeysChange(); StarOk = true; break; }
...
// Normally nKeys will not use thsi
////////////////////////////////////////////////////////
{ //                  012345678901
  char macroMSTA[] = "mstaknMSTAKN";            // MST1 MST2 0-5
  for (int i=0; i<6; i++) MSTAName[i] = 0x00;   // Variable length MSTAName if nKeys
  n++;  
  MSTAName[1] = 48 + n/10;  MSTAName[2] = (n)%10 + 48;   
  MSTAName[0] = macroMSTA[msta+(MacroUL)*6];
  // Serial.println(MSTAName);
  if (msta==5) { int m = n-1; MSTAName[0] = nChar;
                 if (nKeys34&&n<100) { MSTAName[1] = NKeysX[m][1]; MSTAName[2] = NKeysX[m][2]; }
                 else if (nKeys34&&n<1000) { MSTAName[1] = NKeysX[m][1]; MSTAName[2] = NKeysX[m][2]; MSTAName[3] = NKeysX[m][3]; }
                 else { MSTAName[1] = NKeysX[m][1]; MSTAName[2] = NKeysX[m][2]; MSTAName[3] = NKeysX[m][3]; MSTAName[4] = NKeysX[m][4]; }                  
                 strcat(nDir, MSTAName);
               } 
  // Serial.println(MSTAName);
}
///////////////////////////////////////////////////////////////////////////////
