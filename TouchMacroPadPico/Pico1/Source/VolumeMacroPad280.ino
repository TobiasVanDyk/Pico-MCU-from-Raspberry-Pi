...
//
// Adapted by Tobias van Dyk August 2022 - April 2025 - for Pico 1 RP2040 and ILI9488 480x320 LCD
...
{ char *ChrPtr;
  ...
  Serial.println("Version: VolumeMacro280 Tobias van Dyk May 2025 License GPL3");
