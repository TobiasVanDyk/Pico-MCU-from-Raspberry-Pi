...
C:\Users\Tobias\AppData\Local\Arduino15\packages\rp2040\tools\pqt-python3\1.0.1-base-3a57aed-1/python3 -I C:\Users\Tobias\AppData\Local\Arduino15\packages\rp2040\hardware\rp2040\4.5.3/tools/uf2conv.py --serial COM7 --family RP2040 --deploy I:\Data\Win10\Arduino/VolumeMacroPad280.ino.uf2 
Resetting COM7
...
NB: Use 2MB Flash option with 1MB Sketch 1 MB FS 
    ...
    Used here:  #define SPI_FREQUENCY       20000000  // Waveshare use 7MHz - 35MHz still seems ok
                #define SPI_READ_FREQUENCY  16000000  // 20MHz also ok
                #define SPI_TOUCH_FREQUENCY   500000  // 1MHz max 250kHz or 600kHz needed for Pico 2
----------------------------------------------------------------------------------------------------------------
