...
"C:\\Users\\Tobias\\AppData\\Local\\Arduino15\\packages\\rp2040\\tools\\pqt-gcc\\4.0.1-8ec9d6f/bin/arm-none-eabi-size" -A "I:\\Data\\Win10LTSC\\Arduino/VolumeMacroPad281.ino.elf"
Sketch uses 234868 bytes (22%) of program storage space. Maximum is 1044480 bytes.
Global variables use 38936 bytes (14%) of dynamic memory, leaving 223208 bytes for local variables. Maximum is 262144 bytes.
C:\Users\Tobias\AppData\Local\Arduino15\packages\rp2040\tools\pqt-python3\1.0.1-base-3a57aed-1/python3 -I C:\Users\Tobias\AppData\Local\Arduino15\packages\rp2040\hardware\rp2040\4.5.3/tools/uf2conv.py --serial COM7 --family RP2040 --deploy I:\Data\Win10LTSC\Arduino/VolumeMacroPad281.ino.uf2 
Resetting COM7
Converting to uf2, output size: 515584, start address: 0x2000
Scanning for RP2040 devices
Flashing D: (RPI-RP2)
Wrote 515584 bytes to D:/NEW.UF2
----------------------------------------------------------------------------------------------------------------
...
NB: Use 2MB Flash option with 1MB Sketch 1 MB FS 
    ...
    Used here:  #define SPI_FREQUENCY       30000000   // Waveshare use 7MHz - 35MHz still seems ok
                ...
                #define SPI_TOUCH_FREQUENCY   1000000  // 1MHz max 250kHz or 600kHz needed for Pico 2
----------------------------------------------------------------------------------------------------------------

New changes:
1. (Different) custom label files can be on both Flash and SDCard FS. When the [Cf][Opt]Custom-Label is used it will toggle
the SDCard option if A-D is brown, and the Flash FS option if A-D is white. When booting a slow loading of the labels from the
SDCard may cause the TouchLCD to freeze - this can be corrected by doing the loading after setup (still todo), or by loading
the label definitions from the Flash FS.
