...
//
// Adapted by Tobias van Dyk August 2022 - July 2025 - for Pico 1 RP2040 and ILI9488 480x320 LCD
// This is based on the Waveshare 3.5inch Touch Display Module for Raspberry Pi Pico 1 and 2 with included SDCard module:
...
{ char *ChrPtr;
  ...
  Serial.println("Version: VolumeMacro288 Tobias van Dyk July 2025 License GPL3");
