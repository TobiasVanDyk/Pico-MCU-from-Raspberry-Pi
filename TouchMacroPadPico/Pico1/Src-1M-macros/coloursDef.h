...
uint16_t padColor[20]   = {Blue, dCyan,  Purple1, SkyBlue2, Blue, Blue, Black1, SkyBlue2, DCyan,     Red,  
...
const static uint16_t MacroTimerColor[12] = {DGreen, Yellow3, Red, Black1, DGreen, Black, Red, Black1, DGreen, Blue, Red, Black };  
