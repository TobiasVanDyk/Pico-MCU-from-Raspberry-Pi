...
//
// Adapted by Tobias van Dyk August 2022 - October 2025 for Pi Pico 1 RP2040 and ILI9488 480x320 LCD
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Currently last entry ToneOn 0 = Config1[79]; Can use strcpy((char *)&Config1[40], nDir); and inverse, to access as char string array nDirZ=0=EOS 
...
const static int StarCodesMax = 96; // StarCodes Count 16+16+16+16+16+16 StarNum = 0-95
...
{ "*ad*", "*ae*", "*am*", "*as*", "*at*", "*bb*", "*bl*", "*br*", "*ca*", "*cf*", "*cm*", "*cr*", "*ct*", "*cx*", "*db*", "*de*", 
  ...
  "*is*", "*it*",  "*ix*", "*kb*", "*ke*", "*kr*", "*ks*", "*ld*", "*lf*", "*lm*", "*ls*", "*lt*", "*lx*", "*m1*", "*m2*", "*mt*", 
  "*mT*", "*nt*",  "*nT*", "*os*", "*ot*", "*oT*", "*po*", "*r0*", "*r1*", "*r2*", "*r3*", "*rn*", "*ro*", "*rt*", "*rT*", "*sa*", 
...
{ 57,     59,     1,      1,      1,      2,      36,     5,      6,      56,     7,      50,     8,      51,     3,      9,      
  ...
  44,     44,     44,     14,     39,     38,     15,     16,     42,     55,     55,     55,     58,     18,     19,     20,    
  20,     21,     21,     22,     23,     23,     25,     37,     26,     40,     41,     49,     27,     24,     24,     28,     
...
{ char *ChrPtr;
  ...
  Serial.println("Version: VolumeMacro272 1-million-macros - Tobias van Dyk October 2025 License GPL3");
