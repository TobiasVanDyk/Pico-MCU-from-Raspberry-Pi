...
//
// Adapted by Tobias van Dyk August 2022 - July 2025 - for Pi Pico 1 RP2040 and ILI9488 480x320 LCD
...
// 72   MLabel 0       SLabel 0          TLabel 0      DelayTimeVal 0      VolOn1  0                  VolOn2  1               VolOn3 1         
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
{ "*ad*", "*ae*", "*am*", "*as*", "*at*", "*bb*", "*bl*", "*br*", "*ca*", "*cf*", "*cm*", "*cr*", "*ct*", "*cx*", "*db*", "*de*", 
  ...
  "*sm*", "*ss*", "*st*", "*ta*", "*tb*", "*tp*", "*tt*", "*tw*", "*ua*", "*ul*", "*up*", "*vx*", "*x0*", "*x1*", "*x2*", "*x3*", 
  "*x4*", "*x5*", "*x6*", "*x7*", "*x8*", "*x9*", "*0R*", "*09*", "*0d*", "*0n*", "*0p*", "*0s*", "*0t*", "*0x*"  };
...
{ char *ChrPtr;
  ...
  Serial.println("Version: VolumeMacro272 Tobias van Dyk July 2025 License GPL3");
