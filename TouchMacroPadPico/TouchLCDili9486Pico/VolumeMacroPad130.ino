...
//
// Adapted by Tobias van Dyk August 2022 - July 2023 - for ILI9486/ILI9488 480x320 LCD and Adafruit TinyUSB stack
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
/************************************************************************************
...
{ if (ResetOnce) { if (!LittleFS.exists("ResetOnce")) {File f = LittleFS.open("ResetOnce", "w"); f.close(); rp2040.reboot(); }
  ...
  /*
  if (!LittleFS.exists("ResetOnce")&&(ResetOnce)) 
     {File f = LittleFS.open("ResetOnce", "w"); f.close(); rp2040.reboot(); }  // Do once then never unless file ResetOnce deleted and !ResetOnce
  if (ResetOnce) {ResetOnce = false; LittleFS.remove("ResetOnce");}
  */
