...
//
// Adapted by Tobias van Dyk August 2022 - January 2024 - for ILI9486/ILI9488 480x320 LCD and Adafruit TinyUSB stack
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
/************************************************************************************
...
{ "*am*", "*as*", "*at*", "*bb*", "*br*", "*ca*", "*cm*", "*ct*", "*db*", "*de*", "*e0*", "*e1*", "*e2*", "*e3*", "*e4*", 
  ...
  "*nT*", "*os*", "*ot*", "*oT*", "*po*", "*r1*", "*rt*", "*rT*", "*sa*", "*se*", "*sm*", "*ss*", "*st*", "*ta*", "*tb*", 
...
{ char *ChrPtr;
  ...
  Serial.println("Version: VolumeMacro132 GPL3 Tobias van Dyk 31 December 2023");
