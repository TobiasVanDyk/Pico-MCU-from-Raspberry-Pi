...
between a reboot - you have to use the [A-D] and [Sav] keys, for that.
-----------------------------------------------------------------------------------------------------------------------
...
[Cfg][Vo] key option as there will be at least one Layout change when the the [Vo] or [L1-L4] key is held in.
