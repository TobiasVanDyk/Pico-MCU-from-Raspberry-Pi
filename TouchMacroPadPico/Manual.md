...
and the default [Ret]urn key bottom left. If the A-D indicator shows A, B. C, or D then [Var] changes the [Del] 
key function. If the indicator shows X then [Var] changes the [Ret] key function. Change A-D to X by pressing for 
