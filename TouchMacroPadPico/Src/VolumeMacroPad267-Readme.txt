...
"C:\\Users\\Tobias\\AppData\\Local\\Arduino15\\packages\\rp2040\\tools\\pqt-gcc\\4.0.1-8ec9d6f/bin/arm-none-eabi-size" -A "I:\\Data\\Win10\\Arduino/VolumeMacroPad267.ino.elf"
Sketch uses 239148 bytes (22%) of program storage space. Maximum is 1044480 bytes.
Global variables use 37676 bytes (14%) of dynamic memory, leaving 224468 bytes for local variables. Maximum is 262144 bytes.
-------------------------------------------------------------------------------------------------------------------------------------------------
...
4. Remove [Rmv] now deletes folders as well as files - use two '//' in front of directory name entered.
