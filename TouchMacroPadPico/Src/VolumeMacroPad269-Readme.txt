...
"C:\\Users\\Tobias\\AppData\\Local\\Arduino15\\packages\\rp2040\\tools\\pqt-gcc\\4.0.1-8ec9d6f/bin/arm-none-eabi-size" -A "I:\\Data\\Win10\\Arduino/VolumeMacroPad269.ino.elf"
Sketch uses 239892 bytes (22%) of program storage space. Maximum is 1044480 bytes.
Global variables use 38160 bytes (14%) of dynamic memory, leaving 223984 bytes for local variables. Maximum is 262144 bytes.
C:\Users\Tobias\AppData\Local\Arduino15\packages\rp2040\tools\pqt-python3\1.0.1-base-3a57aed-1/python3 -I C:\Users\Tobias\AppData\Local\Arduino15\packages\rp2040\hardware\rp2040\4.5.1/tools/uf2conv.py --serial COM9 --family RP2040 --deploy I:\Data\Win10\Arduino/VolumeMacroPad269.ino.uf2 
Resetting COM9
...
New changes:
1. Added PageUp RedPad(+) and PageDown RedPad(-) for nKeys
2. Fixes in ConfigMacroButtons() void ConfigButtons, changes to buttonpress() to add Pads (+) and (-)
