...
///////////////////////////////////////////////////////////////////////////////////////////
{byte SD3[23] = { 48,49,50,51,37,38,39,40,41,42,29,35,36,17,18,19,20,21,22,23,27,59 };
 byte SD4[23] = { 48,49,50,51,69,70,71,72,73,74,61,67,68,49,50,51,52,53,54,56,27,59 };
 byte n, x = 0;
 
 for (n=0; n<23; n++) if (C==SD3[n]) return n;
 for (n=0; n<23; n++) if (C==SD4[n]) return n; 
...
////////////////////////////////////////////////////////////////////////////////
void SDCardSelectFiles(byte Option)  // Option = 0=[Cfg][Opt] 1=setup(), *sd*n
////////////////////////////////////////////////////////////////////////////////
{ int a, b, c, n, m;
  char SDCardSetX[19] =   {"SDCard Files Set X"};  
  if (Option) c = FindSDNum(SDNum);  
  
  if (SDNum==0) { SDCardArr[0] = SDCardArr[1] = 0x00; return; }  // SDCard File use is disabled = 0x00   
  if (Option) { SDNum = c; SDCardSetX[17] = SD1[c]; status((char *)SDCardSetX); SDCardArr[0] = SDNum; SDCardArr[1] = SD1[c];} // Now SDNum = 1-21  
  ...
  for (n=0; n<24; n++)   
      {if (SDNum==1) strcpy(SDName[n], SDName1[n]);     // *sd*1
       ...
       a = (n+1)/10; b = (n+1) % 10; 
       if (SDNum>3) { SDName[n][0] = SD1[SDNum]; SDName[n][1] = a + 48; n/10; SDName[n][2] = b + 48; SDName[n][3] = 0x00;
