...
-----------------------------------------------------------------------------------------------------------------------
Layout 2B - 36 nKeys n01 to n36 - These keys and files they use, named [n01] to [n36] are not macros, textstrings, or 
linkfiles. They only point to another file via a path - i.e. folder(s) and name, of any length less than 30 characters,
on the same storage (Flash or SDCard), to be executed. For example if file n01 contains the text /passwords/BoA.txt 
then pressing key n01 will send the text from the file BoA.txt in folder /passwords to the focussed, opened application
such as Chrome or notepad.
...
-----------------------------------------------------------------------------------------------------------------------
[n01] [n02] [n03] [n04]       [n13] [n14] [n15] [n16]         [n25] [n26] [n27] [n28]  [s]
[n05] [n06] [n07] [n08]       [n17] [n18] [n19] [n20]         [n29] [n30] [n31] [n32]  [k]
[n09] [n10] [n11] [n12]       [n21] [n22] [n23] [n24]         [n33] [n34] [n35] [n36]  [m]
    Caps  Num  Scroll              C     N     S                   C     N     S       [n]
                                                         Use Pad[o] to switch pages -> [o]
Other indicators:
...
files, repeats, delays etc.) Use the Option Pad [o] to change to the next page - 3 pages with n01-n12, n13-n24, and
n25-n36 are available. They can be stored on both the Flash memory or the SDCard. Switch between the n-Key Mode and 
the Number-Pad mode by using *09*. The n01-n36 files are therefore neither macros, textstrings, or linkfiles. They only
...
(B) *09* toggles between NumPad and nKey n01-n36 mode when Pad [n] is pressed in the Config page. Use Pad [o] to move
    between the 3 pages of each mode.          
-----------------------------------------------------------------------------------------------------------------------
