...
#include <FS.h>
#include <SD.h>          // Case preserving mot case sensitive Up to 30 char filenames
...
cSt char VarStatus[9][40] = {"", "[ Delete ] Options press Pad [o]",  "[ Return ] Options press Pad [o]",
...
cSt char OptStatus[9][42] = {"", "Macro U/L Case Filenames press Pad [o]", "Vol-Mute long-press On/Off use Pad [o]", "L1 - L4 Startup Select use Pad [o]", 
                                 "[ M ] Keys MacroBank 1-5 use Pad [o]",   "[ S ] Keys MacroBank 1-5 use Pad [o]",   "[ T ] Keys MacroBank 1-5 use Pad [o]",
                                 "SDCard FileSet 1-21 Select use Pad [o]", "File List SDCard + Flash press Pad [0]" };
...
/////////////////////////////
{
  ...
  switch(Button){
    case 0: // HOME - Media Previous //////////////////////////////////////////////////////////////////
      ...
      if (ConfigKeyCount==1) {OptNum++; if (OptNum>8) OptNum=0;  
...
{ char *ChrPtr;
  ...
  Serial.println("Version: VolumeMacro186 Tobias van Dyk June 2024 License: GPL3");
...
{ char NameStr[30] = { "" };
  ...
  if (KeyBrdByteNum>0&&KeyBrdByteNum<30) { for (n=0; n<KeyBrdByteNum; n++) NameStr[n] = KeyBrdByte[n]; NameStr[n] = 0x00; }
  ...
  if (!sdCard) RemOK  = LittleFS.remove(NameStr);
...
{ char KeyBrd5status[16] =   {"Macro nn -> Xnn"};
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////// Do *cm* here
  if (KeyBrdByteNum>4) { MST = b; if (MST>4) return;                                          // *cm*nnXmm MSTAK = 0 1 2 3 4 
  ...
  BPtr = MacroBuff; MacroBuffSize = DoFileBytes(0, MSTAName, BPtr, ByteSize, sdCard);  // Read source macro from Flash or SDCard  
...
{ char NameStr[30] = { "" };
  ...
  BPtr = MacroBuff; MacroBuffSize = DoFileBytes(0, NameStr, BPtr, ByteSize, sdCard); 
