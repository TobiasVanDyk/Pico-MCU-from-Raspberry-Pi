...
{ char *ChrPtr;
  ...
  for (n=0; n<10; n++) if (a==MacroChar[n]) { isMacro = true; Serial.println(MSTAName); if (MacroKeys(c, 3)) return; }   // mstak-MSTAK files is macro/string  
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  for (row = 0 + rowcount; row < rows; row++) {   // 3 rows 0,1,2 => b = 0+(0*4)=0 1+(0*4)=1 ... 0+(1*4)=4 ....
   ...
   if (NumKeys) { padLabel[5][0] = '+'; padLabel[9][0] = '-'; padColor[5] = Red;}
           else { padLabel[5][0] = 's'; padLabel[9][0] = 'o'; padColor[5] = Blue;} 
   for (row = 0; row < 5; row++) 
