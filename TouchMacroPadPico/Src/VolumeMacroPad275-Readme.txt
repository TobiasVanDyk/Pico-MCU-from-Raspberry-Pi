...
"C:\\Users\\Tobias\\AppData\\Local\\Arduino15\\packages\\rp2040\\tools\\pqt-gcc\\4.0.1-8ec9d6f/bin/arm-none-eabi-size" -A "I:\\Data\\Win10\\Arduino/VolumeMacroPad275.ino.elf"
Sketch uses 240828 bytes (23%) of program storage space. Maximum is 1044480 bytes.
Global variables use 38244 bytes (14%) of dynamic memory, leaving 223900 bytes for local variables. Maximum is 262144 bytes.
C:\Users\Tobias\AppData\Local\Arduino15\packages\rp2040\tools\pqt-python3\1.0.1-base-3a57aed-1/python3 -I C:\Users\Tobias\AppData\Local\Arduino15\packages\rp2040\hardware\rp2040\4.5.1/tools/uf2conv.py --serial COM7 --family RP2040 --deploy I:\Data\Win10\Arduino/VolumeMacroPad275.ino.uf2 
Resetting COM7
...
New changes:
1. Added nKeys to Linkstring entries - 10 nKeys char from a list enabled in linkstrings. Default is
   ...
   ********************************************************************************************************************
2. Fixed nDir name save and restore in Config1
3. Added Config1 to showKeyData() - use *ld*
4. Changed *0d* handling for no char added
