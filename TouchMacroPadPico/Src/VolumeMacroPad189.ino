...
{ int NameStrLen = 0;
  ...
  // Open File KnnLink nn=01-24 and read groups 3-byte filenames in K1K6File
...
/////////////////////////////
{
  ...
  if ((Button>11)&&(Layout==2)) 
     { PadKeys = true; 
       ...
       if (Button==15) { if (Kbrd) {KeyBrdDirect = !KeyBrdDirect; optionsindicators(0);  
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
bool SaveMacro(bool Overwrite)   // Use Only used by *sa,m,s,t then all 24 are saved to flash or SDCard
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
