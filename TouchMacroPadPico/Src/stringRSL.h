...
char ShutDwn1[12][60] = { "echo Lin-Lin-Lin | sudo -S shutdown -r +10",             // Linux PW = password USER = username
                          "echo Lin-Lin-Lin | sudo -S shutdown -c",                 // echo PW | sudo -S sudo or use echo PW | sudo -S
                          "echo Lin-Lin-Lin | sudo -S shutdown -P +10", "   ",      // Use longer delays if some characters are missing
                          "echo Lin-Lin-Lin | sudo -S shutdown -r +1",  "Cfg",
                          "echo Lin-Lin-Lin | sudo -S shutdown -P +1",  "   ",
                          "echo Lin-Lin-Lin | sudo -S shutdown -r now",
                          "echo Lin-Lin-Lin | sudo -S sudo pkill -SIGKILL -u tobias",
                          "echo Lin-Lin-Lin | sudo -S shutdown -P now", "   " };  
