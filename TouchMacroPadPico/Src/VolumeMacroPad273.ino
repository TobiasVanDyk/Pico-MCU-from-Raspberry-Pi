...
{ int n;
  ...
  DimVal =        Config1[38];
  nKeys34 =       Config1[39];
  strcpy(nDir, (char *)&Config1[40]); // for (n=0; n<20; n++) nDir[n] = Config1[n+40];  // strcpy(nDir, (char *)&Config1[40]);  // Also ok 
  nDirX =         Config1[60];  
}
...
{ int n;
  if (Option==1) { Config1[0] = KeySkip;
                  ...
                  Config1[38] = DimVal; 
                  Config1[39] = nKeys34;                  
                  strcpy((char *)&Config1[40], nDir); // for (n=0; n<20; n++) Config1[n+40] = nDir[n];  // strcpy((char *)&Config1[40], nDir); // Also ok
                  Config1[60] = nDirX;         
                }
...
{ char *ChrPtr;
  ...
  Serial.println("Version: VolumeMacro273 Tobias van Dyk March 2025 License GPL3");
