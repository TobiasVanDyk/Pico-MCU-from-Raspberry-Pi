...
{ char *ChrPtr;
  ...
  // open.
  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  if (!nKeysShow) { a = NKeysX[Button][0];  strcpy(MSTAName, NameStr3);  // mstak-MSTAK files macro/string = tested ok with file m11 on SDCard 
  ...
  // Serial.println(); Serial.print(nFile); Serial.print(" "); Serial.print(NameStr3); Serial.print(" "); Serial.print(nDir);
