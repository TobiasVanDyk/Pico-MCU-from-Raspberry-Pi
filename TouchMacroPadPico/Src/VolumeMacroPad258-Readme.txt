...
"C:\\Users\\Tobias\\AppData\\Local\\Arduino15\\packages\\rp2040\\tools\\pqt-gcc\\4.0.1-8ec9d6f/bin/arm-none-eabi-size" -A "I:\\Data\\Win10\\Arduino/VolumeMacroPad258.ino.elf"
Sketch uses 239740 bytes (22%) of program storage space. Maximum is 1044480 bytes.
Global variables use 38916 bytes (14%) of dynamic memory, leaving 223228 bytes for local variables. Maximum is 262144 bytes.
C:\Users\Tobias\AppData\Local\Arduino15\packages\rp2040\tools\pqt-python3\1.0.1-base-3a57aed-1/python3 -I C:\Users\Tobias\AppData\Local\Arduino15\packages\rp2040\hardware\rp2040\4.4.4/tools/uf2conv.py --serial COM9 --family RP2040 --deploy I:\Data\Win10\Arduino/VolumeMacroPad258.ino.uf2 
Resetting COM9
Converting to uf2, output size: 526848, start address: 0x2000
Scanning for RP2040 devices
Flashing D: (RPI-RP2)
Wrote 526848 bytes to D:/NEW.UF2
-------------------------------------------------------------------------------------------------------------------------------------------------
...
New changes:
1. Cleared  MacroBuffSize = 0; MacroBuff[0] = 0x00; in void DoNKeys(int Button) else it excutes the last macro > 0x7F.
2. Added handling of very large strings preferably stored on the SDCard, through nKeys such as n,o,p,q,r. If nKeys = m,s,t then large 
...
3. Corrected position of check for m s t a k in DoNKeys()
4. Added *Code processing for nKeys: For example with Source p01 construct *bb*7 in the KeyBrd Editor and press [Sav] (not [EXE] that 
...
5. Changed KeyBrd [EXE] and [Sav] to cater for nKeys other than char 'n' - other macro-keyboard-editor functions still need to be tested.
6. Added Undo Redo Ctr+Z Ctr+Y to Macrobank choices
7. Rename *rn*oldname=newname with oldname newname file or /folder names. To test using the keybrd editor choose *rn* with the [*Cm] key, then
