...
Sketch uses 240196 bytes (22%) of program storage space. Maximum is 1044480 bytes.
...
2. MacroEditor opens with current nKeys value after show pressed
3. Fixed wrong c value in DoNKeys()
