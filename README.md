...
* [**How to set up Pi Pico (W) 1.40 SDK on Windows 10x64**](Install-PicoSDK-in-Windows10x64-July2022.pdf), using current (July 2022) versions of all components. The same setup can be used to compile the Waveshare examples for their [**Pico Evaluation board**](https://www.waveshare.com/pico-eval-board.htm) - [**instructions are here**](WavePicoEvaluationBoard.pdf)
