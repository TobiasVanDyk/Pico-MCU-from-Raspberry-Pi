...
Intellikeys: Some the simpler IntelliKeys layouts will be included in the future (Refer to the [**original article**](IntelliKeys/IntelliKeys-the-Smart-Keyboard.pdf) -Source: Johlls Hopkins APL Technical Digest, Volume 13, Number 4 (1992), such as [**this**](IntelliKeys/Arrows_Classic_overlay.jpg) or [**this**](IntelliKeys/Numbers_Classic_overlay.jpg).
