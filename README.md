...
How to do a [**well known duckyscript example**](notepad-hello-world.png) - Open notepad, type hello and increase the text size 3 times - the duckyscript needs about 80-90 key-presses as does the example below.
