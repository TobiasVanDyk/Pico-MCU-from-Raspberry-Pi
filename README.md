...
<img src="https://github.com/TobiasVanDyk/Pico-MCU-from-Raspberry-Pi/blob/main/SetDateTime/images/SetDateTime2.png" width="16" height="16"/> Date Time Display: This is alternative Date Time which is only displayed not used to set the Pico system time-date. The procedure is explained in detail in the SetDateTime section.
