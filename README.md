...
1. [**TouchLCD ILI9486 3.5" 480x320 Volume and Macro Keys**](https://github.com/TobiasVanDyk/Pico-MCU-from-Raspberry-Pi/tree/main/TouchLCDili9486RPi)
2. [**TouchLCD ILI9486 4" 480x320 Volume and Macro Keys**](https://github.com/TobiasVanDyk/Pico-MCU-from-Raspberry-Pi/tree/main/TouchLCDili9486Pico)
3. [**TouchLCD ST7789 2.8" 320x240 Volume and Macro Keys**](https://github.com/TobiasVanDyk/Pico-MCU-from-Raspberry-Pi/tree/main/TouchLCDst7789Pico)
4. [**TouchLCD ILI9488 3.5" 480x320 Volume and Macro Keys**](https://github.com/TobiasVanDyk/Pico-MCU-from-Raspberry-Pi/tree/main/TouchLCDili9488Pico)
