...
{ char *ChrPtr;
  ...
  Serial.println("Version: VolumeMacro261 GPL3 Tobias van Dyk June 2023");
...
{ unsigned long T, z;  // t = timeclock struct
  ...
  // Switch off serial monitor unless *se* toggles CheckSerial but it is not saved default is off
