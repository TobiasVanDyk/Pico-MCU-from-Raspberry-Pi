...
/////////////////////////////
{
  ...
  if ((button>11)&&(Layout==2)) 
     {PadKeys = true; 
      ...
      if (button==16) { return; MouseKeys = !MouseKeys; PadKeysState(button-11, !MouseKeys); return; }       
...
{ char *ChrPtr;
  ...
  Serial.println("VolumeMacroKeys version 180.0");
...
{ uint8_t keycode[6] = { 0 }; // simultaneous keys pressed in here
  ...
  if ((KeyBrdByte[0]==0x2A)&&(KeyBrdByte[1]==0x70)&&(KeyBrdByte[2]==0x6F))  // *po* = Power Keys Menu Option 
  ...
  if ((KeyBrdByte[0]==0x2A)&&(KeyBrdByte[1]==0x74)&&(KeyBrdByte[2]==0x62))    // *tb*num = blank lcd timemout *tb*0,1-9 = infinite,30,60,90,120,240 sec
      {t = TimePeriod; TimePeriod=(KeyBrdByte[4]-48)*30000;                   // 1=30 sec 5=150 sec 6=3 min 9=270 sec
       ...
       // keys or press [Cfg][Rof] again.
       ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   if ((KeyBrdByte[0]==0x2A)&&(KeyBrdByte[1]==0x6F)&&(KeyBrdByte[2]==0x74))    // *ot*num 
      {t = timePowerOff; timePowerOff=(KeyBrdByte[4]-48)*30;                   // 1 = 30 seconds to 9 = 270 seconds
       ...
       WritePowerKeys(timePowerOff, 2); return;}                               // "tRestart", "TRestart", "tPowerOff", "TPowerOff"
  
   if ((KeyBrdByte[0]==0x2A)&&(KeyBrdByte[1]==0x6F)&&(KeyBrdByte[2]==0x54))     // *oT*num 
   ...
   if ((KeyBrdByte[0]==0x2A)&&(KeyBrdByte[1]==0x72)&&(KeyBrdByte[2]==0x74))     // *rt*num 
      {t = timeRestart; timeRestart=(KeyBrdByte[4]-48)*30;                      // 1 = 30 seconds to 9 = 270 seconds
       ...
       WritePowerKeys(timeRestart, 0) ;  return;}                               // "tRestart", "TRestart", "tPowerOff", "TPowerOff"
   if ((KeyBrdByte[0]==0x2A)&&(KeyBrdByte[1]==0x72)&&(KeyBrdByte[2]==0x54))     // *rT*num 
      {t = TimeRestart; TimeRestart=(KeyBrdByte[4]-48)*3000;                    // 1 = 3000 seconds to 9 = 27000 seconds
       ...
       WritePowerKeys(TimeRestart, 1) ;  return;}                               // "tRestart", "TRestart", "tPowerOff", "TPowerOff"       
