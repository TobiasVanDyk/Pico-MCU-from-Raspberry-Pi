...
char padLabel[5][4] = {"", "", "", "", ""}; 
uint16_t padColor[20]   = {Black, Black, Black, Black, Black, Red,   Blue,  Green4, SkyBlue, Yellow,  
  ...
  if (button>11) 
     {PadKeys = true; 
      ...
      if (button==16) { PadKeyY = (!PadKeyY);                                         // PadKeyRBG 0 Toggle 
                        status("Not assigned yet"); return; }
...
{ char *ChrPtr;
  ...
  Serial.println("VolumeMacroKeys version 179.0");
