...
#define STATUS_Y 222 // 225 bottom of y p etc cut-off - 222 very close to buttons last row
...
const static char strL1[] = "L1"; 
const static char strL2[] = "L2";                            
const static char strL3[] = "L3"; 
const static char strL4[] = "L4";      
...
char LayerStr[3] = {"0"};   //Start with 7 follo.owed by the startup layer 1 to 4
...
void setup() {
  ...
  */
  ...
  if (LittleFS.exists("MuteDisable")) MuteDisable = true; else MuteDisable = false;  // VolMute Key active
  if (LittleFS.exists("VolDisable"))  VolDisable = true;  else VolDisable = false; 
...
void buttonpress(int button)
{
  ...
  if ((Layout==2) && (button!=8) && (button!=0) && (button!=2) && (ConfigKeyCount>0)) 
     {ConfigKeyCount = 0; status(""); }                                 // reset if not [Cfg] + [End] [Home] [PageUp] key pressed
  ...
  switch(button){
    ...
    case 5: // CONFIG //////////////////////////////////////////////////
      GetSysInfo(); 
      status("End-Del Hme-Mute PgU-Vol"); 
...
void hid_report_callback(uint8_t report_id, hid_report_type_t report_type, uint8_t const* buffer, uint16_t bufsize)
{
  ...
  **********************************************************/
  ...
  if (Change) 
  {if (CapsLock) {Colours[0][8] = Colours[1][8] = Colours[2][8] = Colours[3][8] = Colours[4][8] = Colours[5][8] = Colours[6][8] = Colours[7][8] = Green2;
                  Colours[8][8] = Colours[9][8] = Colours[10][8] = Colours[11][8] = Colours[12][8] = Colours[13][8] = Colours[14][8] = Colours[15][8] = Green2;} 
       else {Colours[0][8]=Colours[4][8]=LGrey; Colours[1][8]=Colours[5][8]=Blue; Colours[2][8]=Colours[6][8]=Skyblue; Colours[3][8]=Colours[7][8]=Pink;
             Colours[8][8]=Colours[12][8]=LGrey; Colours[9][8]=Colours[13][8]=Blue; Colours[10][8]=Colours[14][8]=Skyblue; Colours[11][8]=Colours[15][8]=Pink; } 
  if (NumLock)   {Colours[0][9] = Colours[1][9] = Colours[2][9] = Colours[3][9] = Colours[4][9] = Colours[5][9] = Colours[6][9] = Colours[7][9] = Green2;
                  Colours[8][9] = Colours[9][9] = Colours[10][9] = Colours[11][9] = Colours[12][9] = Colours[13][9] = Colours[14][9] = Colours[15][9] = Green2; }  
      else  {Colours[0][9]=Colours[4][9]=LGrey; Colours[1][9]=Colours[5][9]=LGrey; Colours[2][9]=Colours[6][9]=Skyblue; Colours[3][9]=Colours[7][9]=Pink; 
             Colours[8][9]=Colours[12][9]=LGrey; Colours[9][9]=Colours[13][9]=LGrey; Colours[10][9]=Colours[14][9]=Skyblue; Colours[11][9]=Colours[15][9]=Pink; } 
  if (ScrollLock) {Colours[0][10] = Colours[1][10] = Colours[2][10] = Colours[3][10] = Colours[4][10] = Colours[5][10] = Colours[6][10] = Colours[7][10] = Green2;
                   Colours[8][10] = Colours[9][10] = Colours[10][10] = Colours[11][10] = Colours[12][10] = Colours[13][10] = Colours[14][10] = Colours[15][10] = Green2; } 
      else  {Colours[0][10]=Colours[4][10]=LGrey; Colours[1][10]=Colours[5][10]=Red; Colours[2][10]=Colours[6][10]=Skyblue; Colours[3][10]=Colours[7][10]=Pink;
             Colours[8][10]=Colours[12][10]=LGrey; Colours[9][10]=Colours[13][10]=Red; Colours[10][10]=Colours[14][10]=Skyblue; Colours[11][10]=Colours[15][10]=Pink;  } 
      ConfigButtons(1);}                                                 // 2 => only last row redraw Buttons and Labels  
...
void GetSysInfo() // Also save config 
{  char *ChrPtr;
