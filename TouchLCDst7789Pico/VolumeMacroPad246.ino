...
//  Adapted by T van Dyk Aug to Dec 2022 for ST7789 320x240 and Adafruit TinyUSB stack
////////////////////////////////////////////////////////////////////////////////////////////// 
/************************************************************************************
...
/////////////////////////////
{
  ...
  if ((button>11)&&(Layout!=2))                                                       // ###
     {if (button==16) { if (LayerAD<3) LayerAD++; else LayerAD = 0;}                  // must be a better way
      ...
      if (button==16||button==12) {PadKeys = true; LayerADLetter[1] = 65 + LayerAD; optionsindicators(0); ConfigMacroButtons(); return; }
    ...
    case 4: // M1 S1 T1 ///////////////////////////////////////////////// Alt + PrintScreen - some mini keyboards cannot do this           
         ...
         if (Layout==4) 
            { if (LinkT[c]==0) { if (MacroKeys(c, 0)) break; }
              ...
              usb_hid.mouseButtonPress(RID_MOUSE, MOUSE_BUTTON_LEFT);  delay(keydelay);
    ...
    case 5: // M2 S2 T2 ///////////////////////////////////////////////// Open admin powershell including UAC completion
         ...
         if (Layout==4) 
            { if (LinkT[c]==0) { if (MacroKeys(c, 0)) break; }
              ...
              usb_hid.mouseButtonPress(RID_MOUSE, MOUSE_BUTTON_MIDDLE);  delay(keydelay);
              usb_hid.mouseButtonRelease(RID_MOUSE);                     delay(keydelay); break; }
    ...
    case 6: // M3 S3 T3 /////////////////////////////////////////////// Open Run window with last coommand visible and selected
         ...
         if (Layout==4) 
            { if (LinkT[c]==0) { if (MacroKeys(c, 0)) break; }
              ...
              usb_hid.mouseButtonPress(RID_MOUSE, MOUSE_BUTTON_RIGHT);  delay(keydelay);
              usb_hid.mouseButtonRelease(RID_MOUSE);                    delay(keydelay); break; }
    ...
    case 8: // M4 S4 T4 ///////////////////////////////////////////// Send a text or macro - could overide by sending serial 0text or macro
         ...
         if (Layout==4) 
            { if (LinkT[c]==0) { if (MacroKeys(c, 0)) break; }
              ...
              usb_hid.mouseScroll(RID_MOUSE, scroll_amount, 0); break; }

              //usb_hid.mouseButtonPress(RID_MOUSE, MOUSE_BUTTON_BACKWARD);  delay(keydelay);
              //usb_hid.mouseButtonRelease(RID_MOUSE);                       delay(keydelay); break; }
    ...
    case 9: // M5 S5 T5 //////////////////////////////////////////// Open normal command prompt via Run window
         ...
         if (Layout==4) 
            { if (LinkT[c]==0) { if (MacroKeys(c, 0)) break; }
              ...
              usb_hid.mouseMove(RID_MOUSE, delta, delta);  delay(keydelay);break; }
    ...
    case 10: // M6 S6 T6 //////////////////////////////////////// M6 text or Enter key LayerAD==1 b = 5; else b =0; 
         ...
         if (Layout==4) 
            { if (LinkT[c]==0) { if (MacroKeys(c, 0)) break; }
              ...
              //usb_hid.mouseButtonPress(RID_MOUSE, MOUSE_BUTTON_FORWARD);  delay(keydelay);
              //usb_hid.mouseButtonRelease(RID_MOUSE);                      delay(keydelay); break; }
  ...
  switch(button){
    ...
    case 4: // ARROW LEFT //////////////////////////////////////////////
      ...
      if (ConfigKeyCount==1) {ConfigKeyCount--; LayerAD++; if (LayerAD==4) LayerAD = 0; LayerADLetter[1] = 65 + LayerAD;
