...
void buttonpress(int button)
{
  ...
  switch(button){
    ...
    case 11: // V- or Enter or Add /////////////////////////////////////////////////////////////////////////////////////////////////////
      if (Kbrd) {if (KeyBrdX==4) {KBDispPos = KBDispPos + 2;  if (KeyBrdByte[0]>0x7F) KBType = true; } // Added char/num in byte arrays
...
{ int n;
  ...
  if ((KeyBrdByte[0]>0x7F) && (KeyBrdByteNum<6))
     {for (n = 0; n < KeyBrdByteNum; n++) {b = KeyBrdByte[n]; keycode[n] = b; }  
          usb_hid.keyboardReport(RID_KEYBOARD, 0, keycode); delay(keydelay);
          usb_hid.keyboardRelease(RID_KEYBOARD);            delay(keydelay);  }
       /*   
      for (n = 0; n < KeyBrdByteNum; n++) 
...
{   int i, n;
    ...
    if (KBType) {
       ...
       if (KeyBrdX==3) if ((button==6)||((button>7)&&(button<11))) {a = KeyBrdFx[KeyBrd123][button-6]; Fx = true;} }  // Xlate F1 - F12
    /*    
