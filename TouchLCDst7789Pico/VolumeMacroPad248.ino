...
bool MouseK = false;                   // 12 Mouse keys active via Pad option                  ***Mouse
...
{ "@", "#", "?", "$", "%", "^", "&", ",", ".", "~", "`", "\\", "\'", "\"", "|", ":", ";" };
const static char StarCode[45][5] =    
{ "*bb*", "*br*", "*ca*", "*cm*", "*ct*", "*db*", "*de*", "*fa*", "*fc*", "*fm*", "*fo*", "*fs*", "*ft*", "*kb*", "*ld*",
  "*lr*", "*m1*", "*m2*", "*mt*", "*mT*", "*nt*", "*nT*", "*ot*", "*oT*", "*po*", "*rt*", "*rT*", "*sa*", "*sm*", "*ss*", 
  "*st*", "*ta*", "*tb*", "*tp*", "*tt*", "*tw*", "*ua*", "*ul*", "*0R*", "*x1*", "*x2*", "*x3*", "*x4*", "*x5*", "*x6*" };
int StarCodesMax = 45; // StarCodes Count 15+15+15
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
{ char *ChrPtr;
  ...
  Serial.println("Version: VolumeMacro248 GPL3 Tobias van Dyk March 2023");
