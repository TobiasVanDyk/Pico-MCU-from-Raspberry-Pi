...
void ConfigButtons(uint8_t rowcount) {  // rowcount=0 all 4 rows rowcount=2 last row only  rowcount=1 no background redraw 
  ...
  if ((Media)&&(b==1)&&(ConfigKeyCount==0)) {for (m=0; m<4; m++) n = mR[m]; {strcpy(keyLabel[n], MediaLabel[n]); }
       keyColor[0] = keyColor[2] = keyColor[4] = keyColor[6] = MediaColour; goto KeyBrdsDone; }
                 
  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  // PowerKeysLabe[3][4] {"Log", "Off", Rst};
  // Bottom row on Cfg Layout 3 Logoff Off Restart
  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  if ((PowerKeys)&&(b==1)&&(ConfigKeyCount==0)) { for (m=8; m<11; m++) {strcpy(keyLabel[m], PowerKeysLabel[m-8]); }
                                                  keyColor[8] = Blue; keyColor[9] = Red; keyColor[10] = Green4; goto KeyBrdsDone; }               
