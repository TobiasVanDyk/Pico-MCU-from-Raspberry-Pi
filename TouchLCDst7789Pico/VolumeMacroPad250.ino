...
//  Adapted by T van Dyk Aug to Apr 2023 for ST7789 320x240 and Adafruit TinyUSB stack
////////////////////////////////////////////////////////////////////////////////////////////// 
/************************************************************************************
...
{ "@", "#", "?", "$", "%", "^", "&", ",", ".", "~", "`", "\\", "\'", "\"", "|", ":", ";" };
const static char StarCode[50][5] =    
{ "*bb*", "*br*", "*ca*", "*cm*", "*ct*", "*db*", "*de*", "*e0", "*e1", "*e2*", "*e3*", "*e4*", "*fa*", "*fc*", "*fm*", 
  "*fo*", "*fs*", "*ft*", "*kb*", "*ld*", "*lr*", "*m1*", "*m2*", "*mt*", "*mT*", "*nt*", "*nT*", "*ot*", "*oT*", "*po*", 
  "*rt*", "*rT*", "*sa*", "*sm*", "*ss*", "*st*", "*ta*", "*tb*", "*tp*", "*tt*", "*tw*", "*ua*", "*ul*", "*0R*", "*x1*", 
  "*x2*", "*x3*", "*x4*", "*x5*", "*x6*" };
int StarCodesMax = 50; // StarCodes Count 15+15+15+5
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
