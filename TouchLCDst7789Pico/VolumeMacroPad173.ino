...
/////////////////////////////////////////////////////////////////////////////////////////////
// Layout 3 small Config Buttons (Red Blue Green) on Far Right side
/////////////////////////////////////////////////////////////////////////////////////////////
#define PAD_W 12          // 15 // Key width   
#define PAD_H 24         // 50 // Key height
#define PAD_SPACING_Y 74 // Next key down 
#define PAD_X 305        // config buttons righthand side
...
{"F01", "   ", "F04", "F07", "F10", 
 "F02", "   ", "F05", "F08", "F11", 
 "F03", "   ", "F06", "F09", "F12"};
// 3 Small Config Buttons on RH side Red Blue Green
char padLabel[3][4] = {"", "", ""}; 
...
void setup() {
  ...
  if (LittleFS.exists("MuteDisable"))      MuteDisable = false;  else MuteDisable = true;   // L1-L4 enabled = defalt VolMute Key disabled 
...
void buttonpress(int button)
{
  ...
  //////////////////////////////////////////////////
  // 3 Config Buttons Red Blue Green button > 11
  ...
  switch(button){
    case 0: // HOME - Media Previous //////////////////////////////////////////////////////////////////
      if (Kbrd) {//KeyBrdByte[KeyBrdByteNum] = KbrdLabel[KeyBrdX][button][KeyBrd123]; 
                 MakeStr(button); //if (KeyBrd123<2) KeyBrd123++; else KeyBrd123=0; 
                 break;}
