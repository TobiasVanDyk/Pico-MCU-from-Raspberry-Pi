...
STL files for the case (based on [**Customizable LCD Box**](https://www.thingiverse.com/thing:57427), are in he folder STL, but is still being 3D-printed to be tested. An alternative easier design was used than in the photo. Flatten the two nipples on the lid until it is a tight fit to the bottom.
