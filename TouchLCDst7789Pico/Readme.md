...
STL files for the case - based on [**Customizable LCD Box**](https://www.thingiverse.com/thing:57427), are in the STL folder - they are still being 3D-printed to be tested. An alternative easier design was used than the design in the photo. Flatten the two nipples on the lid until it is a tight fit to the bottom.
