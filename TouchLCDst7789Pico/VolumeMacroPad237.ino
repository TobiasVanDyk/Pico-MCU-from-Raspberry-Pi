...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
const static char BsDLabel[9][4] = {"Del", "Bks", "Tab", "Ins", "Esc", "PrS",  "Num", "Cap", "Scr" };   // keyLabel = button 3 is V+ or Delete BackSpace Tab 0x2B
const static byte BsDCode[9]     = { DelK,  BckS,  Tab,   Ins,   Esc,   PrtScr, 0x53,  0x39,  0x47 };   // Ins 0x49  BckS 0x2A  DelK 0x4C  Esc 0x29  PrtScr 0x46
int BsDNum = 0 ;                                                    // Index into BsDLabel[0-3]
char BsDNumFile[2] = "0";                                           // char [0] = 0-8 on file = BsDNum ASCII - 65
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
{ "@", "#", "?", "$", "%", "^", "&", ",", ".", "~", "`", "\\", "\'", "\"", "|", ":", ";" };
const static char StarCode[37][5] =    
{ "*bb*", "*br*", "*ca*", "*cm*", "*ct*", "*db*", "*de*", "*fa*", "*fc*", "*fm*", "*fo*", "*fs*", "*ft*", 
  "*kb*", "*ld*", "*lr*", "*mt*", "*mT*", "*nt*", "*nT*", "*ot*", "*oT*", "*po*", "*rt*", "*rT*", "*sa*", 
  "*sm*", "*ss*", "*st*", "*ta*", "*tb*", "*tp*", "*tt*", "*tw*", "*ua*", "*ul*", "*0R*" };
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////
{
  ...
  switch(button){
    ...
    case 3: ////////////////////////////////////////////////////// Volume Increase or Delete BackSpace Tab Insert
     ...
     if (VolDisable) { keycode[0] = BsDCode[BsDNum];      // Delete BackSpace Tab Insert Esc PrtScr Num Caps Scroll
                       keycode[1] = 0x00; 
                       usb_hid.keyboardReport(HIDKbrd, 0, keycode); delay(keydelay); 
  ...
  switch(button){
    ...
    case 3: // V+ or Delete or Escape(Math) or Execute(Keybrd) //////////////////////////////////////
     ...
     if (MacroTimerDisp) { MacroTimer7 = !MacroTimer7; MacroTimer18 = MacroTimer18 || MacroTimer7;
      ...
      if (VolDisable) { keycode[0] = BsDCode[BsDNum];      // Delete BackSpace Tab Insert Esc PrtScr Capslock Numlocl Scrolllock
                        keycode[1] = 0x00;   
                        usb_hid.keyboardReport(HIDKbrd, 0, keycode); delay(keydelay); 
                        usb_hid.keyboardRelease(HIDKbrd); break; }
...
{   int i, n;
    ...
    if (KeyBrdX==2) {if (button==10) {a = KeyBrdFx[KeyBrdF1F24]; Fx = true;}  // Xlate F1-F24 - see if (a>0) below where it is used 
                     ...
                     if (button==6)  { for (n=0; n<4; n++) { b = StarCode[StarNum][n]; KeyBrdByte[n] = b; KBDisp[n] = b; } 
                                       ...
                                       StarNum++; if (StarNum==37) StarNum = 0;      return; } }
