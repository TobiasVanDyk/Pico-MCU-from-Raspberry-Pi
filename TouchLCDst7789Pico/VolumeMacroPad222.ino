...
{ "@", "#", "?", "$", "%", "^", "&", ",", ".", "~", "`", "\\", "\'", "\"", "|", ":", ";" };
const static char StarCode[15][5] =    
{ "*bb*", "*db*", "*tb*", "*ot*", "*oT*", "*rt*", "*rT*", "*po*", "*cm*", "*ca*", "*po*", "*fo*", "*ul*", "*kb*", "*mk*" };
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
bool LinkMacro()
////////////////////////////////////////////////////////////////////////////////////////////////////
// Two stage 1. Link two MacroNum1 to MacroNum2 - use only Option1 Option2 not SD
...
{   int i, n;
    ...
    if (KeyBrdX==2) {if (button==10) {a = KeyBrdFx[KeyBrdF1F24]; Fx = true;}             // Xlate F1-F24 - see if (a>0) below where it is used 
                     ...
                     if (button==6)  { for (n=0; n<4; n++) { b = StarCode[StarNum][n]; KeyBrdByte[n] = b; KBDisp[n] = b; } 
                                       ...
                                       StarNum++; if (StarNum==15) StarNum = 0;      return; } }
