...
void hid_report_callback(uint8_t report_id, hid_report_type_t report_type, uint8_t const* buffer, uint16_t bufsize)
{
  ...
  **********************************************************/
  ...
  if (Change) {if (CapsLock)   { Colours[0][8] =  TFT_DARKGREEN; Colours[1][8] =  TFT_DARKGREEN; } // TFT_OLIVE TFT_DARKGREEN TFT_MAROON
                   else        { Colours[0][8] =  TFT_LIGHTGREY; Colours[1][8] =  TFT_BLUE;      } 
               if (NumLock)    { Colours[0][9] =  TFT_DARKGREEN; Colours[1][9] =  TFT_DARKGREEN; }
                   else        { Colours[0][9] =  TFT_LIGHTGREY; Colours[1][9] =  TFT_LIGHTGREY; } 
               if (ScrollLock) { Colours[0][10] = TFT_DARKGREEN; Colours[1][10] = TFT_DARKGREEN; } // TFT_GREENYELLOW almost same
                   else        { Colours[0][10] = TFT_LIGHTGREY; Colours[1][10] = TFT_RED;       } 
               ConfigButtons();}                                                                   // Draw Buttons and Labels  
