...
// Can derive a, s, t, m, filenames - then only store 1 byte per file - save 172 x 3 bytes
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
{"L14", "BsD",  "Vol", "   ", "A-D",  "Sav", "McT",  "   ",  "Med", "ROf", "S12", "   "};  // All 3 chars + \0
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
const static char BsDLabel[4][4] = {"Del", "Bks", "Tab", "Ins" };   // keyLabel = button 3 is V+ or 4 below Delete BackSpace Tab Insert
const static byte BsDCode[4]     = { DelK,  BckS,  Tab,   Ins };    // Tab 0x2B  Ins 0x49  BckS 0x2A  DelK 0x4C 
int BsDNum = 0 ;                                                    // Index into BsDLabel[0-3]
char BsDNumFile[2] = "0";                                           // char [0] = 0-3 on file = BsDNum ASCII - 65
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
char * str1to12[] = {str1, str2, str3, str4, str5, str6, str7, str8, str9, str10,str11,str12,str13,str14,str15,str16,str17,str18,str19,str20,str21,str22,str23,str24} ;
...
/////////////////////////////
{
  ...
  switch(button){
    ...
    case 3: ////////////////////////////////////////////////////// Volume Increase or Delete BackSpace Tab Insert
     ...
     if (VolDisable) { keycode[0] = BsDCode[BsDNum];      // Delete BackSpace Tab Insert
                       usb_hid.keyboardReport(HIDKbrd, 0, keycode); delay(keydelay); 
                       usb_hid.keyboardRelease(HIDKbrd); break; }
...
{ String NameStr;
  ...
  if (MST1==0) { NameStr = MTRname[Option1]; RemOK = LittleFS.remove(NameStr); }    // Delete Read Source File M1 - M24               
  if (MST1==1) { NameStr = STRname[Option1]; RemOK = LittleFS.remove(NameStr); }    // Delete Read Source File S1 - S24  
  if (MST1==2) { NameStr = TTRname[Option1]; RemOK = LittleFS.remove(NameStr); }    // Delete Read Source File T1 - T24 
