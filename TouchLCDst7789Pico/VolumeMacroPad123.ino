...
#define STATUS_Y 223 // 225 bottom of y p etc cut-off - 222 very close to buttons last row
...
uint16_t Colours[16][12] = {Blue,    Red,     Orange,  DCyan,    // Row 1 Normal L1
                            LGrey,   LGrey,   LGrey,   DCyan,    // Row 2
                            LGrey,   LGrey,   LGrey,   DCyan,    // Row 3
                            ...
                            LGrey,   LGrey,   LGrey,   DCyan, 
                            LGrey,   LGrey,   LGrey,   Red,
                            Blue,    LGrey,   Red,     Blue,     // Navigation
                            LGrey,   Black,   LGrey,   DCyan, 
                            Blue,    LGrey,   Red,     Red,
                            Blue,    Red,     Orange,  Blue,     // Text Macros S1-S6
                            Skyblue, Skyblue, Skyblue, DCyan, 
                            Skyblue, Skyblue, Skyblue, Red,
                            Blue,    Red,     Orange,  Blue,     // Text Macros T1-T6
                            Pink,    Pink,    Pink,    DCyan, 
                            Pink,    Pink,    Pink,    Red,
                            Blue,    Red,     Orange,  Blue,     // Normal + VolMute OFF
                            LGrey,   LGrey,   LGrey,   Violet, 
                            LGrey,   LGrey,   LGrey,   Red,
                            Blue,    LGrey,   Red,     Blue,     // Navigation + VolMute OFF
                            LGrey,   Black,   LGrey,   Violet, 
                            Blue,    LGrey,   Red,     Red,
                            Blue,    Red,     Orange,  Blue,     // Text Macros S1-S6 + VolMute OFF
                            Skyblue, Skyblue, Skyblue, Violet, 
                            Skyblue, Skyblue, Skyblue, Red,
                            Blue,    Red,     Orange,  Blue,     // Text Macros T1-T6 + VolMute OFF
                            Pink,    Pink,    Pink,    Violet, 
                            Pink,    Pink,    Pink,    Red };
...
void buttonpress(int button)
{
  ...
  if ((Layout==2) && (button!=8) && (button!=0) && (button!=2) && (ConfigKeyCount>0)) 
     {ConfigKeyCount = 0; status(""); }                                 // reset if not [i] + [End] or [Home] key pressed
