...
{ "@", "#", "?", "$", "%", "^", "&", ",", ".", "~", "`", "\\", "\'", "\"", "|", ":", ";" };
const static char StarCode[21][5] =    
{ "*bb*", "*db*", "*tb*", "*ot*", "*oT*", "*rt*", "*rT*", "*po*", "*cm*", "*ca*", "*po*", "*fo*", "*ul*", "*ua*", "*kb*", "*lr*", "*ld*", "*fm*", "*fs*", "*ft*", "*fa*" };
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
bool Rotate180 = true;          // Rotate screen 180 degrees so that USB cable is on other side
...
bool  SaveReadLinks = false;                            // set via *lr* - later default true
...
{ unsigned long t, z;
  ...
  if (KeyBrdByte[1]==0x66&&KeyBrdByte[2]==0x74)         // *ft* = Fill T keys with predefined coded strings
     {FillKeysStr(4); status("[S1-[S12] filled");  return true; }
  ...
  if (KeyBrdByte[1]==0x74&&KeyBrdByte[2]==0x6)                    // *tb*num = blank lcd timemout *tb*0,1-9 
...
{   int i, n;
    ...
    if (KeyBrdX==2) {if (button==10) {a = KeyBrdFx[KeyBrdF1F24]; Fx = true;}             // Xlate F1-F24 - see if (a>0) below where it is used 
                     ...
                     if (button==6)  { for (n=0; n<4; n++) { b = StarCode[StarNum][n]; KeyBrdByte[n] = b; KBDisp[n] = b; } 
                                       ...
                                       StarNum++; if (StarNum==21) StarNum = 0;      return; } }
