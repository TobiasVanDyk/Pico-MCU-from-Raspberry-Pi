...
bool CapsLock = false;             // If true change color of bottom three keys Colours = [0,1][8,9,10]
bool NumLock = false;              // If true change color of bottom three keys Colours = [0,1][8,9,10]
bool ScrollLock = false;           // If true change color of bottom three keys Colours = [0,1][8,9,10]
  ...
  switch(button){
    ...
    case 4:
      ...
      for (n=0;  n<strlen(Str4); n++) 
          {usb_hid.keyboardPress(RID_KEYBOARD, Str4[n]);
          delay(keydelay2);
          usb_hid.keyboardRelease(RID_KEYBOARD);
          delay(keydelay2); }
      break;
    case 5:
      ...
      keycode[1] = HID_KEY_M;
      keycode[2] = HID_KEY_D;
      keycode[3] = KeyEnter;   // or use 0x9E;
      usb_hid.keyboardReport(RID_KEYBOARD, 0, keycode);
      has_key = true;
      delay(keydelay2);
      break;
