...
// Indicators status Character C N S XPos[7] = {0, 0, 78, 156, 0, 78, 156};
...
uint16_t Colours[16][12] = {BrG, Orange,   // Row 1 Normal L1 ///////////////////// 12 Keys group 0 12x4=48
                            ...
                            LG3, Violet, 
                            LG3, Orange,   // [4][8]
                            BlgR,Orange,   // Navigation + VolMute OFF L2
                            LbL, Violet, 
                            BlgR,Orange,   // [5][8]
                            ...
                            LG3, Violet, 
                            LG3, Red,      // [12][8]
                            BlgR,Blue,     // Navigation + Vol OFF VolMute OFF 
                            LbL, Violet, 
                            BlgR,Red,      // [13][8]
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#define CutPst "Cut", "Cpy", "Pst"
#define cXcV   "cX",  "cC",  "cV"
#define HmPgU  "Hme", "Up",  "PgU"
#define LcR    "<",   "Cfg", ">"
#define EnPgD  "End", "Dwn", "PgD"
#define S13    "S1",  "S2",  "S3"
#define S46    "S4",  "S5",  "S6"
#define T13    "T1",  "T2",  "T3"
#define T46    "T4",  "T5",  "T6"
...
{CutPst, "V+",  M13,  "Vo",  M46,   "V-",  // L1 Mute ON Vol=ON   0     Group 0 Layer A
 HmPgU,  "V+",  LcR,  "Vo",  EnPgD, "V-",  // L2                  1
 cXcV,   "V+",  S13,  "Vo",  S46,   "V-",  // L3                  2
 cXcV,   "V+",  T13,  "Vo",  T46,   "V-",  // L4                  3
 CutPst, "V+",  M13,  "L1",  M46,   "V-",  // L1 Mute OFF Vol=ON    4    Group 1 Layer A 
 HmPgU,  "V+",  LcR,  "L2",  EnPgD, "V-",  //                       5
 cXcV,   "V+",  S13,  "L3",  S46,   "V-",  //                       6
 cXcV,   "V+",  T13,  "L4",  T46,   "V-",  //                       7
 CutPst, "BsD", M13,  "Vo",  M46,   "Ent", // L1 Mute ON Vol=OFF  8      Group 2 Layer A
 HmPgU,  "BsD", LcR,  "Vo",  EnPgD, "Ent", //                     9
 cXcV,   "BsD", S13,  "Vo",  S46,   "Ent", //                     10
 cXcV,   "BsD", T13,  "Vo",  T46,   "Ent", //                     11
 CutPst, "BsD", M13,  "L1",  M46,   "Ent", // L1 Mute OFF Vol=OFF    12  Group 3 Layer A
 HmPgU,  "BsD", LcR,  "L2",  EnPgD, "Ent", //                        13
 cXcV,   "BsD", S13,  "L3",  S46,   "Ent", //                        14
 cXcV,   "BsD", T13,  "L4",  T46,   "Ent", //                        15
 CutPst, "V+",  M79,  "Vo",  M12,   "V-",  // L1 Mute ON Vol=ON          Group 0 Layer B 
 HmPgU,  "V+",  LcR,  "Vo",  EnPgD, "V-",  // L2
 cXcV,   "V+",  S79,  "Vo",  S12,   "V-",  // L3
 cXcV,   "V+",  T79,  "Vo",  T12,   "V-",  // L4
 CutPst, "V+",  M79,  "L1",  M12,   "V-",  // L1 Mute OFF Vol=ON         Group 1 Layer B
 HmPgU,  "V+",  LcR,  "L2",  EnPgD, "V-",
 cXcV,   "V+",  S79,  "L3",  S12,   "V-",
 cXcV,   "V+",  T79,  "L4",  T12,   "V-",
 CutPst, "BsD", M79,  "Vo",  M12,   "Ent", // L1 Mute ON Vol=OFF         Group 2 Layer B
 HmPgU,  "BsD", LcR,  "Vo",  EnPgD, "Ent",
 cXcV,   "BsD", S79,  "Vo",  S12,   "Ent",
 cXcV,   "BsD", T79,  "Vo",  T12,   "Ent",
 CutPst, "BsD", M79,  "L1",  M12,   "Ent", // L1 Mute OFF Vol=OFF        Group 3 Layer B 
 HmPgU,  "BsD", LcR,  "L2",  EnPgD, "Ent",
 cXcV,   "BsD", S79,  "L3",  S12,   "Ent",
 cXcV,   "BsD", T79,  "L4",  T12,   "Ent"};
...
// Must add code to add values for F1 to F12, (1F3=F1,F2,F3) (1F2=F10,F11,F12) and SCA (Shift, Control, Alt)
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
const static char KbrdLabel[4][12][4] = 
{"abc",  "def",  "ghi",  "ESC", "jkl", "mno", "pqr", "NXT", "stu", "vwx", "yz ", "ADD",
 "ABC",  "DEF",  "GHI",  "esc", "JKL", "MNO", "PQR", "nxt", "STU", "VWX", "YZ ", "add",
 "012",  "345",  "678",  "ESC", "9+-", "=*/", "1F3", "NXT", "4F6", "7F9", "1F2", "ADD",
 "\\|?", "<\">", "(\')", "END", "!@#", "$%^", "&,.", "NXT", "[:]", "{;}", "SCA", "ADD" };
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool Kbrd = false;             // Layer for KeyBrd
int KeyBrdX = 0;               // values 0 1 2 3
...
void setup() {
  ...
  */
  ...
  InitStr();  // Copy str# to Str# and Ttr# if no saved file else read Str# Ttr# from files, if Mtr files exist copy those to M1 to M12
  ...
  switch(button){
    case 0: // HOME - Media Previous //////////////////////////////////////////////////////////////////
      if (Kbrd) {KeyBrdByte[KeyBrdByteNum] = KbrdLabel[KeyBrdX][button][KeyBrd123]; 
                 status((char *)KeyBrdByte); if (KeyBrd123<2) KeyBrd123++; else KeyBrd123=0; break;}
    ...
    case 3: // V+ or Delete or Escape(Keybrd) //////////////////////////////////////
      if (Kbrd) {Kbrd = false; status((char *)KeyBrdByte); 
                 if ((KeyBrdX==3)&&(KeyBrdByteNum>0)) {delay(500); status("values sent");} KeyBrdX = 0; ConfigButtons(1); break;}
    ...
    case 7: // Vol Mute /////////////////////////////////////////////////////////
      if (Kbrd) {if (KeyBrdX<3) KeyBrdX++; else KeyBrdX=0; ConfigButtons(1); break;} 
...
{  char *ChrPtr;
  ...
  if (Media) { char MediaD[2]  = "1"; ChrPtr = MediaD; DoFileStrings(1, "MediaKeys",  ChrPtr); }
         else LittleFS.remove("MediaKeys");

  if (DelBS) { char DelBSD[2]  = "1"; ChrPtr = DelBSD; DoFileStrings(1, "DeleteBackspace",  ChrPtr); }
