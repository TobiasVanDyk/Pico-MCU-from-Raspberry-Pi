  ...
  switch(button){    
    ...
    case 4: // M1 S1 T1 ///////////////////////////////////////////////// Alt + PrintScreen - some mini keyboards cannot do this           
         ...
         if (Layout==4) 
            { if (!LayerAxD) { if (LinkT[c]==0) { if (MacroKeys(c, 0)) break; }
              ...
              status("Key T1,7,13,19 pressed");  break; }  // Layout=4 Do something else 
    ...
    case 5: // M2 S2 T2 ///////////////////////////////////////////////// Open admin powershell including UAC completion
         ...
         if (Layout==4) 
            { if (!LayerAxD) { if (LinkT[c]==0) { if (MacroKeys(c, 0)) break; }
                               if (LinkT[c]>0)  { if (MacroLinkT(c))   break; } }                               
              status("Key T2,8,14,20 pressed");  break; }  // Layout=4 Do something else 
    ...
    case 6: // M3 S3 T3 /////////////////////////////////////////////// Open Run window with last coommand visible and selected
         if (Layout==3) 
            { if (!LayerAxD) { if (LinkS[c]==0) { if (MacroKeys(c, 0)) break; }
                               if (LinkS[c]>0)  { if (MacroLinkS(c))   break; } }
              status("Key S3,9,15,21 pressed");  break; }  // Layout=3 Do something else 
               
         if (Layout==4) 
            { if (!LayerAxD) { if (LinkT[c]==0) { if (MacroKeys(c, 0)) break; }
                               if (LinkT[c]>0)  { if (MacroLinkT(c))   break; } }                               
              status("Key T3,9,15,21 pressed");  break; }  // Layout=4 Do something else 
    ...
    case 8: // M4 S4 T4 ///////////////////////////////////////////// Send a text or macro - could overide by sending serial 0text or macro
         ...
         if (Layout==4) 
            { if (!LayerAxD) { if (LinkT[c]==0) { if (MacroKeys(c, 0)) break; }
                               if (LinkT[c]>0)  { if (MacroLinkT(c))   break; } }                               
              status("Key T4,10,16,22 pressed");  break; }  // Layout=4 Do something else 
    ...
    case 9: // M5 S5 T5 //////////////////////////////////////////// Open normal command prompt via Run window
         if (Layout==3) 
            { if (!LayerAxD) { if (LinkS[c]==0) { if (MacroKeys(c, 0)) break; }
                               if (LinkS[c]>0)  { if (MacroLinkS(c))   break; } }
              status("Key S5,11,17,23 pressed");  break; }  // Layout=3 Do something else   

         if (Layout==4) 
            { if (!LayerAxD) { if (LinkT[c]==0) { if (MacroKeys(c, 0)) break; }
                               if (LinkT[c]>0)  { if (MacroLinkT(c))   break; } }                               
              status("Key T5,11,17,23 pressed");  break; }  // Layout=4 Do something else 
    ...
    case 10: // M6 S6 T6 //////////////////////////////////////// M6 text or Enter key LayerAD==1 b = 5; else b =0; 
         if (Layout==3) 
            { if (!LayerAxD) { if (LinkS[c]==0) { if (MacroKeys(c, 0)) break; }
                               if (LinkS[c]>0)  { if (MacroLinkS(c))   break; } }
              status("Key S6,12,18,24 pressed");  break; }  // Layout=3 Do something else   

         if (Layout==4) 
            { if (!LayerAxD) { if (LinkT[c]==0) { if (MacroKeys(c, 0)) break; }
                               if (LinkT[c]>0)  { if (MacroLinkT(c))   break; } }                               
              status("Key T6,12,18,24 pressed");  break; }  // Layout=4 Do something else 
