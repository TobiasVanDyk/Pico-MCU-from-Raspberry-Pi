...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Two Layers A B of four by four layout sets of 12 button labels <name>[<number-of-lables>][<number-of-chars-per-label]
// The number of chars per label include the termination char \0 => 3 character labels here
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
const static char Labels[2][16][12][4] =                                            // 2 Layers A B - 4 x 4 Layouts 1 2 3 4 - 12 Keys - 4 characters
...
const static char str8[] = "08\n"; 
const static char str9[] = "09"; 
const static char str10[] = "10\n\r"; 
const static char str11[] = "11\r";                            // Str3[5] = {'c','m','d','\r','\0'};
...
void buttonpress(int button)
{
  ...
  if (LayerAB==1) b = 6; else b = 0;     // 6 x offset for S1-S6 -> S7-S12, T1-T6 -> T7-T12
  if (button>6) a = 5; else a = 4;       // button 4 5 6 then skip 1 => 8 9 10
  c = button + b - a;                    // c = 4 + 0 - 4 = 0 or c = 4 + 6 - 4 = 6 first button  str[0] str[6]
                                         // c = 8 + 0 - 5 = 3 or c = 8 + 6 - 5 = 9 fourth button str[3] str[9]
  ...
  if ((Layout==2) && (button!=8) && (button!=0) && (button!=2) && (button!=10) && (button!=4) && (ConfigKeyCount>0)) 
  ...
  switch(button){
    ...
    case 4: // M1 S1 T1 ///////////////////////////////////////////////// Alt + PrintScreen - some mini keyboards cannot do this
      ...
      if (Layout==4) { for (n=0;  n<strlen(Str1to12[c]); n++) 
