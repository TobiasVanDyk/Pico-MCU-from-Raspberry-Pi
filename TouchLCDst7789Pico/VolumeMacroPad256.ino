...
//  Adapted by T van Dyk Aug to May 2023 for ST7789 320x240 and Adafruit TinyUSB stack
////////////////////////////////////////////////////////////////////////////////////////////// 
/************************************************************************************
...
int OptionOS = 0; // 0 Windows 1 Linux 2 Apple
...
// Problem: min is a reserved key word Aduino uses it as min() (macro) function - but Pico SDK rtc.h use it as minutes .min
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
{ "@", "#", "?", "$", "%", "^", "&", ",", ".", "~", "`", "\\", "\'", "\"", "|", ":", ";" };
const static char StarCode[51][5] =    
{ "*bb*", "*br*", "*ca*", "*cm*", "*ct*", "*db*", "*de*", "*e0", "*e1", "*e2*", "*e3*", "*e4*", "*fa*", "*fc*", "*fm*", 
  "*fo*", "*fs*", "*ft*", "*kb*", "*ld*", "*lr*", "*m1*", "*m2*", "*mt*", "*mT*", "*nt*", "*nT*","*os*","*ot*", "*oT*", 
  "*po*", "*rt*", "*rT*", "*sa*", "*sm*", "*ss*", "*st*", "*ta*", "*tb*", "*tp*", "*tt*", "*tw*", "*ua*", "*ul*", "*0R*", 
  "*x1*", "*x2*", "*x3*", "*x4*", "*x5*", "*x6*" };
int StarCodesMax = 51; // StarCodes Count 15+15+15+6
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
char ShutDwn1[12][60] = { "echo PASSWORD | sudo -S shutdown -r +10",             // Linux
                          "echo PASSWORD | sudo -S shutdown -c",                 // echo science | sudo -S sudo or use echo science | sudo -S
...
{ uint8_t keycode[6] = { 0 };     // simultaneous keys pressed in here                  
  ...
  if ((Menu)&&(s>0)) { keycode[0] = GuiL;             // or use HID_KEY_GUI_RIGHT
   ...
   if (OptionOS==1) {keycode[0] = CtrL;               // Ctr+Alt+T open terminal 
                     ...
                     keycode[2] = HID_KEY_T;          // Ubuntu 20 and Mint 21 loose focus to desktop search box
...
{ unsigned long T, z;  // t = timeclock struct
  ...
  if (KeyBrdByte[1]==0x6F&&KeyBrdByte[2]==0x73)           // *os* operating system toggle linux on/off
     { OptionOS++; if (OptionOS>1) OptionOS=0; if (OptionOS==1) status("Linux"); if (OptionOS==0) status("Windows"); return true; }
...
void optionsindicators(int Option) {
  ...
  LayerADLetter[0] = 97 + LayerAD;
  tft.drawString(LayerADLetter, OPT_X+145, OPT_Y-143);

  if (OptionOS) tft.drawString("L", OPT_X+145, OPT_Y-73); else tft.drawString("w", OPT_X+145, OPT_Y-73); 
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*
   if (OptionOS==1) {keycode[0] = AltL;   // Alt+F2 then gnome-terminal + Enter     
                     keycode[1] = F02;
                     keycode[2] = 0x00; 
                     usb_hid.keyboardReport(HIDKbrd, 0, keycode);   delay(keydelay);  
                     usb_hid.keyboardRelease(HIDKbrd);              delay(keydelay); 
   ...
   if (OptionOS==1) { keycode[0] = HID_KEY_T; 
