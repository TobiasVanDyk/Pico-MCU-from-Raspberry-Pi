...
{"Cut", "Cpy", "Pst", "V+",  "M1",  "M2", "M3",  "Vo",  "M4",  "M5",  "M6",  "V-",  // L1 Mute ON Vol=ON                 0
...
void buttonpress(int button)
{
  ...
  switch(button){
    ...
    case 5: // CONFIG //////////////////////////////////////////////////
      GetSysInfo(0); 
      if (ConfigKeyCount==1) {status("Config and Files Saved");          ConfigKeyCount = 0; break;}
                        else {status("L1-4 DelRet layerAB Save Del L12"); ConfigKeyCount++ ;  } 
      ConfigButtons(1);
      break;
    case 6: // ARROW RIGHT /////////////////////////////////////////////
      keycode[0] = ArrRight;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  if (ConfigKeyCount>0) 
     {for (m=0; m<3; m++) {keyLabel[0][m] = CfgLabel[0][m]; keyLabel[2][m] = CfgLabel[2][m]; keyLabel[4][m] =  CfgLabel[4][m]; 
          ...
          keyColor[0] = keyColor[2] = keyColor[4] = keyColor[5] = keyColor[8] = keyColor[10] = Magenta; 
          if (Colours[0][8]==Green2)  keyColor[8]  = Colours[0][8];
          if (Colours[0][10]==Green2) keyColor[10] = Colours[0][10]; }  // if Capslock Numlock
