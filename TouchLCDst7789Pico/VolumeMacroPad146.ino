...
///////////////////////////////////////////////////////////////////////////////////
uint16_t Colours[16][12] = {Blue,    Red,     Purple,  Orange,    // Row 1 Normal L1 ///////////////////// 12 Keys group 0 12x4=48
                            ...
                            Blue,    Red,     Purple,  Orange,    // Text Macros S1-S6 L3
                            SkyBlue, SkyBlue, SkyBlue, Orange, 
                            SkyBlue, SkyBlue, SkyBlue, Orange,    // [2][8]
                            Blue,    Red,     Purple,  Orange,    // Text Macros T1-T6 l4
                            Pink,    Pink,    Pink,    Orange, 
                            Pink,    Pink,    Pink,    Orange,    // [3][8]
                            Blue,    Red,     Purple,  Orange,    // Normal + VolMute OFF L1 ///////////// 12 Keys group 1 12x8=96
                            ...
                            Blue,    Red,     Purple,  Orange,    // Text Macros S1-S6 + VolMute OFF L3
                            SkyBlue, SkyBlue, SkyBlue, Violet, 
                            SkyBlue, SkyBlue, SkyBlue, Orange,    // [6][8]
                            Blue,    Red,     Purple,  Orange,    // Text Macros T1-T6 + VolMute OFF L4
                            Pink,    Pink,    Pink,    Violet, 
                            Pink,    Pink,    Pink,    Orange,    // [7][8]
                            Blue,    Red,     Purple,  Blue,     // Normal + Vol OFF L1 ///////////////// 12 Keys group 2 12x12=144
                            LGrey,   LGrey,   LGrey,   Orange, 
                            LGrey,   LGrey,   LGrey,   Red,      // [8][8]
                            Blue,    LGrey,   Red,     Blue,     // Navigation
                            LGrey,   Black,   LGrey,   Orange, 
                            Blue,    LGrey,   Red,     Red,      // [9][8]
                            Blue,    Red,     Purple,  Blue,     // Text Macros S1-S6
                            SkyBlue, SkyBlue, SkyBlue, Orange, 
                            SkyBlue, SkyBlue, SkyBlue, Red,      // [10][8]
                            Blue,    Red,     Purple,  Blue,     // Text Macros T1-T6
                            Pink,    Pink,    Pink,    Orange, 
                            Pink,    Pink,    Pink,    Red,      // [11][8]
                            Blue,    Red,     Purple,  Blue,     // Normal + Vol OFF VolMute OFF //////// 12 Keys group 3 12x16=192
                            LGrey,   LGrey,   LGrey,   Violet, 
                            LGrey,   LGrey,   LGrey,   Red,      // [12][8]
                            Blue,    LGrey,   Red,     Blue,     // Navigation + Vol OFF VolMute OFF 
                            LGrey,   Black,   LGrey,   Violet, 
                            Blue,    LGrey,   Red,     Red,      // [13][8]
                            Blue,    Red,     Purple,  Blue,     // Text Macros S1-S6 + Vol OFF VolMute OFF 
                            SkyBlue, SkyBlue, SkyBlue, Violet, 
                            SkyBlue, SkyBlue, SkyBlue, Red,      // [14][8]
                            Blue,    Red,     Purple,  Blue,     // Text Macros T1-T6 + Vol OFF VolMute OFF 
                            Pink,    Pink,    Pink,    Violet, 
  ...
  switch(button){
    ...
    case 5: // CONFIG //////////////////////////////////////////////////
      ...
      if (ConfigKeyCount==1) {status("Config and Files Saved");          ConfigKeyCount = 0; }
                        else {status("L1L4 DelRet AB Save Med Del L1L2"); ConfigKeyCount++ ; } 
      ConfigButtons(1);
      break;
    case 6: // ARROW RIGHT /////////////////////////////////////////////
      if (ConfigKeyCount==1) {ConfigKeyCount--;
