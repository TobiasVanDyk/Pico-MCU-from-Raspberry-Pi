  ...
  switch(button){
    ...
    case 9: // ARROW DOWN //////////////////////////////////////////////
      ...
      if (ConfigKeyCount==1) {ConfigKeyCount--; PowerKeys = !PowerKeys; 
          if (PowerKeys) status("[Log]off  Power[Off]  [Rst]Restart"); else status(" ");
          ConfigButtons(1); break;}   
...
void ConfigButtons(uint8_t rowcount) {  // rowcount=0 all 4 rows rowcount=2 last row only  rowcount=1 no background redraw 
  ...
  if (Math) { for (m=0; m<3; m++) 
                 {keyLabel[0][m]  =  MathLabel[MathX][0][m];   keyLabel[1][m]  =  MathLabel[MathX][1][m]; 
                  ...
                  keyColor[6]=keyColor[5]=keyColor[8]=keyColor[9]=keyColor[10]=MathColour1; goto KeyBrdsDone; }
  ...
  if (Kbrd) { for (m=0; m<3; m++) 
                 {keyLabel[0][m]  =  KbrdLabel[KeyBrdX][0][m];   keyLabel[1][m]  =  KbrdLabel[KeyBrdX][1][m]; 
                  ...
                  keyColor[6]=keyColor[7]=keyColor[8]=keyColor[9]=keyColor[10]=keyColor[11]=CfgColour; goto KeyBrdsDone; }
  ...
  if (MouseKeys) { for (m=0; m<3; m++) 
                 {keyLabel[0][m] = Mousekeys1[0][m];   keyLabel[1][m] = Mousekeys1[1][m]; 
                  ...
                  keyColor[6]=keyColor[7]=keyColor[8]=keyColor[9]=keyColor[10]=keyColor[11]=Pink; goto KeyBrdsDone; }
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
