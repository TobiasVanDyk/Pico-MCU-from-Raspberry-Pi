...
Note that the **default pins are now (April 2021) changed** - see [**A**](https://github.com/earlephilhower/arduino-pico/pull/103) and [**B**](https://github.com/earlephilhower/arduino-pico/issues/92) and [**C**](https://github.com/earlephilhower/arduino-pico/commit/6e51516d6c07fcf84fe5580e0fda69b0b010aab3): From TwoWire Wire(i2c0, 0, 1); TwoWire Wire1(i2c1, 2, 3); to TwoWire Wire(i2c0, PIN_WIRE0_SDA, PIN_WIRE0_SCL); TwoWire Wire1(i2c1, PIN_WIRE1_SDA, PIN_WIRE1_SCL); 
